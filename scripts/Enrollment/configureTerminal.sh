...
zsh_config="https://raw.githubusercontent.com/ahrenstein/noodling/master/zsh/zshrc"

# Download a zsh configuration for the current user
sudo -H -iu ${ConsoleUser} /usr/bin/curl https://raw.githubusercontent.com/ahrenstein/noodling/master/zsh/zshrc > /Users/${ConsoleUser}/.zshrc
